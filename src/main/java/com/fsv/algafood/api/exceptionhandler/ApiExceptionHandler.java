...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @Override
    protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex, HttpHeaders headers, HttpStatusCode httpStatus, WebRequest request) {
        ...
        String detail = "O corpo da requisição está inválido. Verifique o erro da síntaxe.";

        Problem problem = createProblemBuilder((HttpStatus) httpStatus, problemType, detail)
    ...
    private ResponseEntity<Object> handleValidationInternal(Exception ex, BindingResult bindingResult, HttpHeaders headers,HttpStatusCode httpStatusCode,WebRequest request) {
        ...
        return handleExceptionInternal(ex, problem, headers, httpStatusCode, request);
    }

    private ResponseEntity<Object> handleMethodArgumentTypeMismatch(MethodArgumentTypeMismatchException ex, HttpHeaders headers, HttpStatusCode httpStatusCode, WebRequest request) {
        ...
        Problem problem = createProblemBuilder((HttpStatus) httpStatusCode, type, detail)
                .userMessage(detail)
                .build();
    ...
    private ResponseEntity<Object> handlePropertyBinding(PropertyBindingException ex, HttpHeaders headers, HttpStatusCode httpStatus, WebRequest request) {
    ...
    private ResponseEntity<Object> handleInvalidFormat(InvalidFormatException ex, HttpHeaders headers, HttpStatusCode httpStatus, WebRequest request) {
