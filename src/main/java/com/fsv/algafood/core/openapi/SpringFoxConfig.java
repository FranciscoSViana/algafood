package com.fsv.algafood.core.openapi;

import com.fasterxml.classmate.TypeResolver;
import com.fsv.algafood.api.exceptionhandler.Problem;
import com.fsv.algafood.api.model.CozinhaModel;
import com.fsv.algafood.api.openapi.model.CozinhasModelOpenApi;
import com.fsv.algafood.api.openapi.model.PageableModelOpenApi;
...
public class SpringFoxConfig implements WebMvcConfigurer {
    ...
    private List<Response> globalGetResponseMessages() {
        return Arrays.asList(
                ...
                new ResponseBuilder()
                        ...
                        .description("Recurso não possio representação que pode ser aceita pelo consumidor")
                        .build()
        );
    }
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        ...
        registry.addResourceHandler("/webjars/**")
                .addResourceLocations("class:/META-INF/resources/webjars/");
    }

    private Consumer<RepresentationBuilder> getProblemaModelReference() {
        return r -> r.model(m -> m.name("Problema")
                .referenceModel(ref -> ref.key(k -> k.qualifiedModelName(
                        q -> q.name("Problema").namespace("com.fsv.algafood.api.exceptionhandler")))));
    }
}
